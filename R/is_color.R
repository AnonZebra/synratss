...
#' "white", "black" or "hazy". r/g/b each take a two-value numeric vector providing
...
is_color <- function(hex, col = NULL, r = NULL, g = NULL, b = NULL) {
  ...
  if (!is.null(col)) {
    if (col == "blue") {comp_vals <- c(0, 80, 0, 80, 190, 255)}
    else if (col == "red") {comp_vals <- c(190, 255, 0, 80, 0, 80)}
    else if (col == "green") {comp_vals <- c(0, 80, 190, 255, 0, 80)}
    else if (col == "black") {comp_vals <- c(0, 33, 0, 33, 0, 33)}
    else if (col == "white") {comp_vals <- c(222, 255, 222, 255, 222, 255)}
    else if (col == "hazy") {comp_vals <- c(100, 150, 100, 150, 100, 150)}
  } else {comp_vals <- c(r, g, b)}
  pri_rgb <- col2rgb(hex)
